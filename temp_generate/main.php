...
if(isset($_POST['submit1']))
{
	...
	}else
	{
         ...
         //echo"<script>alert('".$card."')</script>";
            ...
            }else
            {
                ...
                { 
                    ...
                    $insert=mysqli_query($con,"INSERT INTO `color_sticker`(`card`,`status`,`in_status`,`used`,`box_no`,`adate`,`qrcat`,`print`) VALUES ('$invID','0','0','0','$password','$adate','vis','0')");
                }   
            }// Else for Over Limit  
        ...
        if($insert)
        {
            ...
            echo "<script>window.location.href = 'generate_color_sticker.php';</script>";
        }
