...
?>
	<body >
	     <h1>Sheet = <?php  echo   $sh;    ?></h1>
	         ...
	         $codesl=mysqli_query($con,"SELECT * FROM `op_allocate_wh` WHERE used = 0  AND box_no = '$sh'  ORDER BY id ASC");
	         $line = 0;
        	...
        	?>
					...
					<?php
					    mysqli_query($con,"UPDATE `op_allocate_wh` SET `used` = '1' WHERE `box_no` = '$sh' "); 
					?>		
