...
?>
	<body >
	     <h1>Sheet = <?php  echo   $sh;    ?></h1>
	         ...
	         $codesl=mysqli_query($con,"SELECT * FROM `cre_bar3` WHERE print_status = 0  AND box_no = '$sh'  ORDER BY id ASC");
	         $line = 0;
	           ...
	           <div class="col-md-2">
	            ...
	            <div class="sub1"  style="background-color:<?php echo $color; ?>">
							<div class="logo_l">
							    ...
							    <p><?php echo $contact['card_ref'];   ?></p>
						   <span style="margin-left: 35px;"><?php echo $contact['jdate']; ?></span>
        	...
        	?>
					...
					<?php
					    mysqli_query($con,"UPDATE `cre_bar3` SET `print_status` = '1' WHERE `box_no` = '$sh' "); 
					?>		
