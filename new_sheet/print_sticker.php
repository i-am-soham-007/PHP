...
?>
	<body >
	     <h1>Sheet = <?php  echo   $sh;    ?></h1>
	         ...
	         $codesl=mysqli_query($con,"SELECT * FROM `color_sticker` WHERE print = 0  AND box_no = '$sh'  ORDER BY id ASC");
	         $line = 0;
        	...
        	?>
					...
					<?php
					    mysqli_query($con,"UPDATE `color_sticker` SET `print` = '1' WHERE `box_no` = '$sh' "); 
					?>		
